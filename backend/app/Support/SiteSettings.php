...
class SiteSettings
{
    ...
    public static function definitions(): array
    {
        return [
            ...
            'property_cta_label' => ['default' => 'মোট খরচের হিসাব নিন', 'rules' => ['string', 'min:2', 'max:30']],
            'property_cta_label_hidden_price' => ['default' => 'দাম ও মোট খরচ জানুন', 'rules' => ['string', 'min:2', 'max:30']],
            'property_cta_note' => ['default' => 'রেজিস্ট্রেশন, নামজারিসহ সব খরচ মিলিয়ে হিসাব WhatsApp-এ পাঠাব। কোনো টাকা লাগবে না।', 'rules' => ['string', 'max:160']],
