  ...
  <div class="property-page" lang="bn">
    ...
    <div v-else class="property-shell">
      ...
      <header class="property-heading">
        ...
        <div class="asking-price"><span>তালিকাভুক্ত মূল্য</span><strong>{{ priceLabel }}</strong><small v-if="!property.hidePrice">{{ property.priceUnit || 'মূল্য ও অন্তর্ভুক্ত খরচ নিশ্চিত করুন' }}</small><button class="text-action" @click="openInquiry('price')">মোট খরচ ও পেমেন্টের শর্ত জানুন <ArrowUpRight :size="16" /></button></div>
      </header>
      ...
      <div class="property-body">
        <div class="property-information">
          <nav class="section-nav" aria-label="প্রপার্টির বিভাগ"><a href="#property-overview">বিস্তারিত</a><a href="#property-documents">কাগজপত্র</a><a href="#property-location">লোকেশন</a><a href="#property-questions">আপনার প্রশ্ন</a></nav>
          ...
          <section id="property-documents" class="detail-section">
            ...
            <p v-else class="muted-note">এই পেজে এখনও প্রকৃত ব্রোশিওর যুক্ত হয়নি। উপলব্ধ কাগজপত্র সম্পর্কে টিমকে জিজ্ঞেস করতে পারেন।</p><button class="text-action" @click="openInquiry('documents')">কাগজপত্র ও খরচ নিয়ে কথা বলতে চাই <ArrowRight :size="16" /></button>
          </section>
          ...
          <section id="property-questions" class="detail-section faq-section"><p class="eyebrow">সহজ উত্তর</p><h2>আপনার মনে হতে পারে</h2><details><summary>ফর্ম পূরণ করলে কি বুকিং হয়ে যাবে?</summary><p>না। এটি শুধু এই প্রপার্টি সম্পর্কে তথ্য ও যোগাযোগের অনুরোধ। কোনো টাকা বা বুকিংয়ের অঙ্গীকার প্রয়োজন নেই।</p></details><details><summary>তালিকাভুক্ত দামের বাইরে খরচ আছে?</summary><p>রেজিস্ট্রেশন, কর, সার্ভিস চার্জ এবং প্রযোজ্য হলে নির্মাণ খরচ মূল্যের মধ্যে আছে কি না, টিমের কাছে পূর্ণ হিসাব চেয়ে নিন। এই পেজে চূড়ান্ত মোট খরচ নিশ্চিত করা হয়নি।</p></details><details><summary>এখনই কিনব না, তবু কথা বলা যাবে?</summary><p>অবশ্যই। ফর্মে আপনার আসল সময়সীমা বেছে নিন। আপনার প্রস্তুতি অনুযায়ী আলোচনা করা যাবে।</p></details><details><summary>ফর্ম জমা দেওয়ার পর কী হবে?</summary><p>GBREL টিম আপনার দেওয়া নম্বরে, পছন্দের মাধ্যমে যোগাযোগ করবে। ঐচ্ছিকভাবে সময় বা আগে জানতে চাওয়া বিষয়ও জানাতে পারবেন।</p></details></section>
        </div>
...
const priceLabel = computed(() => property.value?.hidePrice ? 'দাম জানতে যোগাযোগ করুন' : formatBDT(property.value?.price ?? 0))
